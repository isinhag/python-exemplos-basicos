...
try:
    ...
    icon_path = Image.open(icon_path)
    icon_path = ImageTk.PhotoImage(icon_image)
...
# Define a regra de validação para Entry
...
my_botton = ctk.CTkButton(my_frame, text="Gerar senha forte", command=new_rand, image=create_image, compound="left", font= ("Helvetica", 16), fg_color="#4CAF50", hover_color="#45a049")
my_botton.grid(row=0, column=0, padx=10)
